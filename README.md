...
| [⚽ MyTrainer](https://gredos.usal.es/handle/10366/151439) | - 📍 Seguimiento de jugadores usando balizas fijas
- ⚙️ Comunicación en tiempo real mediante el protocolo `MQTT` y la librería `Socket.IO`
- 🖥️ Visualización en una aplicación web con estadísticas interactivas
